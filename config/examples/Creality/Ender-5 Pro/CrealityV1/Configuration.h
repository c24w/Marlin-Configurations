...
// #define STRING_CONFIG_H_AUTHOR "(c24w, Ender-5 Pro)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET_X 45
#define NOZZLE_TO_PROBE_OFFSET_Y 8
...
#define HOMING_FEEDRATE_MM_M { (160*60), (160*60), (10*60) }
