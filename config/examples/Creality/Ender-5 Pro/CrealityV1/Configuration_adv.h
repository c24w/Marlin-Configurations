...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_1_DESC "Move Nozzle To Probe"
  #define NOZZLE_TO_PROBE_XY "X" STRINGIFY(NOZZLE_TO_PROBE_OFFSET_X) " Y" STRINGIFY(NOZZLE_TO_PROBE_OFFSET_Y)
  #define MAIN_MENU_ITEM_1_GCODE "G91\nG0 " NOZZLE_TO_PROBE_XY " F3000\nG90"
